...
 docker run -d --name=whoami_multiple_host_published_samebridge_02 --network=my-bridge-net-06 --publish=91:80 containous/whoami
docker run -d --name=whoami_multiple_host_published_samebridge_04 --network=my-bridge-net-06 --publish=93:80 containous/whoami
