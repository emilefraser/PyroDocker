...
echo "Test compled"
docker network create -d bridge my-bridge-net-01
docker network create -d bridge my-bridge-net-02
docker network create -d bridge my-bridge-net-03
docker run -d -P --name whoami_multiple_bridge-01 --network my-bridge-net-01 containous/whoami
docker run -d -P --name whoami_multiple_bridge-02 --network my-bridge-net-02 containous/whoami
docker run -d -P --name whoami_multiple_bridge-03 --network my-bridge-net-03 containous/whoami
docker run -d -P --name whoami_multiple_bridge-04 --network my-bridge-net-03 containous/whoami
